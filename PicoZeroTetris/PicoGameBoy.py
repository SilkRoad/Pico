...
class PicoGameBoy(ST7789):
    def __init__(self):
        self.__up = Pin(10, Pin.IN, Pin.PULL_UP)
        self.__down = Pin(11, Pin.IN, Pin.PULL_UP)
        self.__left = Pin(12, Pin.IN, Pin.PULL_UP)
        self.__right = Pin(13, Pin.IN, Pin.PULL_UP)
        self.__button_A = Pin(6, Pin.IN, Pin.PULL_UP)
        self.__button_B = Pin(7, Pin.IN, Pin.PULL_UP)
        self.__buzzer = PWM(Pin(15))
        super().__init__(width=240, height=240, id_=0, sck=2, mosi=3,
                         dc=0, rst=5, cs=1, bl=4, baudrate=62500000)
